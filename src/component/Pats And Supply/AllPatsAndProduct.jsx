        ...
        >
            ...
            >
                ...
                <div className="absolute top-4 left-4">
                    <motion.div 
                        className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-full px-3 py-1.5 flex items-center gap-1 shadow-sm cursor-help"
